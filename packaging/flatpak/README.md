...
```text
flatpak-builder --force-clean build-dir packaging/flatpak/io.github.morningfrog.LinkForge.yml
flatpak-builder --user --install --force-clean build-dir packaging/flatpak/io.github.morningfrog.LinkForge.yml
flatpak run io.github.morningfrog.LinkForge
flatpak-builder-lint manifest packaging/flatpak/io.github.morningfrog.LinkForge.yml
